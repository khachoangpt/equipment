		...
		<div className="relative w-full min-w-fit">
			...
			{clearable && onClear && (
				<button
					...
					className="absolute cursor-pointer bg-gray-100 right-8 top-1/2 -translate-y-1/2 flex items-center justify-center rounded-sm p-0.5 hover:bg-muted transition-colors"
