...
import useSearchEquipmentRepairController from '../../controllers/search-equipment-repair.controller'
...
const SearchEquipmentRepair = ({ onOpenChange, open }: Props) => {
	const { form, onSubmit } = useSearchEquipmentRepairController()
	const { control } = form
						...
						<div className="grid grid-cols-2 gap-x-10 gap-y-3">
							...
							<FormField
								...
								render={({ field: { value, onChange } }) => (
									<FormItem className="flex items-center">
										<FormLabel className="w-full">Đơn vị gửi</FormLabel>
										<FormControl>
...
export default SearchEquipmentRepair
