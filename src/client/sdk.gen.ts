...
export class SyncEquipmentsInstancesService {
     ...
     */
    public static equipmentInstancesControllerGetInstancesWithGroupedDetails<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
