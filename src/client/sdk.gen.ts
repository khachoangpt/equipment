...
export class EquipmentDisposeService {
    /**
     * [Admin] Kiểm tra số lượng trang bị trước khi thanh lý
     */
    public static equipmentDisposeControllerValidateQuantities<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentDisposeControllerValidateQuantitiesData, ThrowOnError>) {
        return (options?.client ?? client).post<EquipmentDisposeControllerValidateQuantitiesResponse, EquipmentDisposeControllerValidateQuantitiesError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipment-dispose/validate-quantities'
        });
    }
...
export class SyncEquipmentsInstancesService {
    ...
    /**
     * Lấy danh sách trang bị với chi tiết được nhóm theo trạng thái và chất lượng
     */
    public static equipmentInstancesControllerGetInstancesWithGroupedDetails<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentInstancesControllerGetInstancesWithGroupedDetailsResponse, EquipmentInstancesControllerGetInstancesWithGroupedDetailsError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/with-grouped-details'
        });
    }
    
    /**
     * Lấy danh sách chi tiết được nhóm theo ID trang bị, đơn vị sử dụng và chất lượng
     */
    public static equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnit<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitResponse, EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/details-grouped-by-instance'
        });
    }
    
    /**
     * [Admin] Cập nhật tồn kho trang bị (số lượng, trạng thái, chất lượng)
     */
    public static equipmentInstancesControllerUpdateInventory<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentInstancesControllerUpdateInventoryData, ThrowOnError>) {
        return (options?.client ?? client).patch<EquipmentInstancesControllerUpdateInventoryResponse, EquipmentInstancesControllerUpdateInventoryError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/{id}/inventory'
        });
    }
    ...
    /**
     * Lấy dữ liệu tồn kho trang bị
     */
    public static equipmentInstancesControllerGetInventoryData<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentInstancesControllerGetInventoryDataResponse, EquipmentInstancesControllerGetInventoryDataError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/inventory-data'
        });
    }
    
    /**
     * Xuất báo cáo tồn kho trang bị ra file PDF
     */
    public static equipmentInstancesControllerGenerateInventoryReport<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentInstancesControllerGenerateInventoryReportResponse, EquipmentInstancesControllerGenerateInventoryReportError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/export/inventory-report'
        });
    }
    
    /**
     * Tạo PDF Biểu kiểm kê trang bị tổng hợp (đa chiều: nguồn cấp, chất lượng, đơn vị)
     */
    public static equipmentInstancesControllerGetGeneralInventoryReport<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentInstancesControllerGetGeneralInventoryReportResponse, EquipmentInstancesControllerGetGeneralInventoryReportError, ThrowOnError>({
            ...options,
            url: '/api/v1/equipments/instances/export/general-inventory-report'
        });
    }
