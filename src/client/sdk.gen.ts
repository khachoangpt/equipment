...
export class AssemblyEquipmentsComponentsService {
    ...
    /**
     * Tạo PDF cho hoạt động xây dựng trang bị lắp ráp
     */
...
export class HandoverEquipmentService {
    ...
    /**
     * Xuất file PDF Biên bản bàn giao từ Activity Log
     */
