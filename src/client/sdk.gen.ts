...
export class EquipmentsService {
    /**
     * Thêm một trang bị mới (Admin, Manager)
     */
    public static equipmentsControllerCreate<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentsControllerCreateData, ThrowOnError>) {
        return (options?.client ?? client).post<EquipmentsControllerCreateResponse, EquipmentsControllerCreateError, ThrowOnError>({
            ...options,
            url: '/api/equipments'
        });
    }
    ...
    /**
     * Lấy danh sách tất cả trang bị
     */
    public static equipmentsControllerFindAll<ThrowOnError extends boolean = true>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentsControllerFindAllResponse, EquipmentsControllerFindAllError, ThrowOnError>({
            ...options,
            url: '/api/equipments'
        });
    }
     ...
     */
    public static equipmentsControllerFindOne<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentsControllerFindOneData, ThrowOnError>) {
        return (options?.client ?? client).get<EquipmentsControllerFindOneResponse, EquipmentsControllerFindOneError, ThrowOnError>({
            ...options,
    ...
    /**
     * Cập nhật thông tin trang bị (Admin, Manager)
     */
    public static equipmentsControllerUpdate<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentsControllerUpdateData, ThrowOnError>) {
        return (options?.client ?? client).patch<EquipmentsControllerUpdateResponse, EquipmentsControllerUpdateError, ThrowOnError>({
            ...options,
            url: '/api/equipments/{id}'
        });
    }
    ...
    /**
     * Xoá một trang bị (Admin, Manager)
     */
    public static equipmentsControllerRemove<ThrowOnError extends boolean = true>(options: OptionsLegacyParser<EquipmentsControllerRemoveData, ThrowOnError>) {
        return (options?.client ?? client).delete<EquipmentsControllerRemoveResponse, EquipmentsControllerRemoveError, ThrowOnError>({
            ...options,
            url: '/api/equipments/{id}'
        });
    }
