...
export const assembledEquipmentControllerGenerateAssemblyCheckPdfQueryKey = (options: OptionsLegacyParser<AssembledEquipmentControllerGenerateAssemblyCheckPdfData>) => [
    createQueryKey('assembledEquipmentControllerGenerateAssemblyCheckPdf', options)
];

export const assembledEquipmentControllerGenerateAssemblyCheckPdfOptions = (options: OptionsLegacyParser<AssembledEquipmentControllerGenerateAssemblyCheckPdfData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await AssemblyEquipmentsComponentsService.assembledEquipmentControllerGenerateAssemblyCheckPdf({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: assembledEquipmentControllerGenerateAssemblyCheckPdfQueryKey(options)
    });
};

export const assembledEquipmentControllerGenerateInventoryReportLayoutQueryKey = (options?: OptionsLegacyParser) => [
    createQueryKey('assembledEquipmentControllerGenerateInventoryReportLayout', options)
];

export const assembledEquipmentControllerGenerateInventoryReportLayoutOptions = (options?: OptionsLegacyParser) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await AssemblyEquipmentsComponentsService.assembledEquipmentControllerGenerateInventoryReportLayout({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: assembledEquipmentControllerGenerateInventoryReportLayoutQueryKey(options)
    });
};

export const assembledEquipmentControllerGenerateInventoryReportLayoutMutation = (options?: Partial<OptionsLegacyParser>) => {
    const mutationOptions: UseMutationOptions<AssembledEquipmentControllerGenerateInventoryReportLayoutResponse, AxiosError<AssembledEquipmentControllerGenerateInventoryReportLayoutError>, OptionsLegacyParser> = {
        mutationFn: async (localOptions) => {
            const { data } = await AssemblyEquipmentsComponentsService.assembledEquipmentControllerGenerateInventoryReportLayout({
                ...options,
                ...localOptions,
...
export const userHistoryControllerCreateQueryKey = (options: OptionsLegacyParser<UserHistoryControllerCreateData>) => [
    createQueryKey('userHistoryControllerCreate', options)
];

export const userHistoryControllerCreateOptions = (options: OptionsLegacyParser<UserHistoryControllerCreateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerCreate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: userHistoryControllerCreateQueryKey(options)
    });
};

export const userHistoryControllerCreateMutation = (options?: Partial<OptionsLegacyParser<UserHistoryControllerCreateData>>) => {
    const mutationOptions: UseMutationOptions<UserHistoryControllerCreateResponse, AxiosError<UserHistoryControllerCreateError>, OptionsLegacyParser<UserHistoryControllerCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerCreate({
                ...options,
                ...localOptions,
...
export const userHistoryControllerSearchQueryKey = (options?: OptionsLegacyParser<UserHistoryControllerSearchData>) => [
    createQueryKey('userHistoryControllerSearch', options)
];

export const userHistoryControllerSearchOptions = (options?: OptionsLegacyParser<UserHistoryControllerSearchData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerSearch({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: userHistoryControllerSearchQueryKey(options)
    });
};

export const userHistoryControllerSearchInfiniteQueryKey = (options?: OptionsLegacyParser<UserHistoryControllerSearchData>): QueryKey<OptionsLegacyParser<UserHistoryControllerSearchData>> => [
    createQueryKey('userHistoryControllerSearch', options, true)
];

export const userHistoryControllerSearchInfiniteOptions = (options?: OptionsLegacyParser<UserHistoryControllerSearchData>) => {
    return infiniteQueryOptions<UserHistoryControllerSearchResponse, AxiosError<UserHistoryControllerSearchError>, InfiniteData<UserHistoryControllerSearchResponse>, QueryKey<OptionsLegacyParser<UserHistoryControllerSearchData>>, number | Pick<QueryKey<OptionsLegacyParser<UserHistoryControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<UserHistoryControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: userHistoryControllerSearchInfiniteQueryKey(options)
    });
};

export const userHistoryControllerFindByUserIdQueryKey = (options: OptionsLegacyParser<UserHistoryControllerFindByUserIdData>) => [
    createQueryKey('userHistoryControllerFindByUserId', options)
];

export const userHistoryControllerFindByUserIdOptions = (options: OptionsLegacyParser<UserHistoryControllerFindByUserIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerFindByUserId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: userHistoryControllerFindByUserIdQueryKey(options)
    });
};

export const userHistoryControllerFindByAccountIdQueryKey = (options: OptionsLegacyParser<UserHistoryControllerFindByAccountIdData>) => [
    createQueryKey('userHistoryControllerFindByAccountId', options)
];

export const userHistoryControllerFindByAccountIdOptions = (options: OptionsLegacyParser<UserHistoryControllerFindByAccountIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerFindByAccountId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: userHistoryControllerFindByAccountIdQueryKey(options)
    });
};

export const userHistoryControllerFindOneQueryKey = (options: OptionsLegacyParser<UserHistoryControllerFindOneData>) => [
    createQueryKey('userHistoryControllerFindOne', options)
];

export const userHistoryControllerFindOneOptions = (options: OptionsLegacyParser<UserHistoryControllerFindOneData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await CoreUserHistoryService.userHistoryControllerFindOne({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: userHistoryControllerFindOneQueryKey(options)
    });
};
...
export const equipmentDisposeControllerValidateQuantitiesQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerValidateQuantitiesData>) => [
    createQueryKey('equipmentDisposeControllerValidateQuantities', options)
];

export const equipmentDisposeControllerValidateQuantitiesOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerValidateQuantitiesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerValidateQuantities({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerValidateQuantitiesQueryKey(options)
    });
};

export const equipmentDisposeControllerValidateQuantitiesMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerValidateQuantitiesData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerValidateQuantitiesResponse, AxiosError<EquipmentDisposeControllerValidateQuantitiesError>, OptionsLegacyParser<EquipmentDisposeControllerValidateQuantitiesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerValidateQuantities({
                ...options,
                ...localOptions,
...
export const equipmentDisposeControllerDisposeQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerDisposeData>) => [
    createQueryKey('equipmentDisposeControllerDispose', options)
];

export const equipmentDisposeControllerDisposeOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerDisposeData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerDispose({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerDisposeQueryKey(options)
    });
};

export const equipmentDisposeControllerDisposeMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerDisposeData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerDisposeResponse, AxiosError<EquipmentDisposeControllerDisposeError>, OptionsLegacyParser<EquipmentDisposeControllerDisposeData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerDispose({
                ...options,
                ...localOptions,
...
export const equipmentDisposeControllerSearchQueryKey = (options?: OptionsLegacyParser<EquipmentDisposeControllerSearchData>) => [
    createQueryKey('equipmentDisposeControllerSearch', options)
];

export const equipmentDisposeControllerSearchOptions = (options?: OptionsLegacyParser<EquipmentDisposeControllerSearchData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerSearch({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerSearchQueryKey(options)
    });
};

export const equipmentDisposeControllerSearchInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentDisposeControllerSearchData>): QueryKey<OptionsLegacyParser<EquipmentDisposeControllerSearchData>> => [
    createQueryKey('equipmentDisposeControllerSearch', options, true)
];

export const equipmentDisposeControllerSearchInfiniteOptions = (options?: OptionsLegacyParser<EquipmentDisposeControllerSearchData>) => {
    return infiniteQueryOptions<EquipmentDisposeControllerSearchResponse, AxiosError<EquipmentDisposeControllerSearchError>, InfiniteData<EquipmentDisposeControllerSearchResponse>, QueryKey<OptionsLegacyParser<EquipmentDisposeControllerSearchData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentDisposeControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentDisposeControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentDisposeControllerSearchInfiniteQueryKey(options)
    });
};

export const equipmentDisposeControllerFindOneQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerFindOneData>) => [
    createQueryKey('equipmentDisposeControllerFindOne', options)
];

export const equipmentDisposeControllerFindOneOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerFindOneData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerFindOne({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerFindOneQueryKey(options)
    });
};

export const equipmentDisposeControllerUpdateMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerUpdateData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerUpdateResponse, AxiosError<EquipmentDisposeControllerUpdateError>, OptionsLegacyParser<EquipmentDisposeControllerUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerUpdate({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentDisposeControllerRemoveMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerRemoveData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerRemoveResponse, AxiosError<EquipmentDisposeControllerRemoveError>, OptionsLegacyParser<EquipmentDisposeControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerRemove({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentDisposeControllerFindByInstanceIdQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerFindByInstanceIdData>) => [
    createQueryKey('equipmentDisposeControllerFindByInstanceId', options)
];

export const equipmentDisposeControllerFindByInstanceIdOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerFindByInstanceIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerFindByInstanceId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerFindByInstanceIdQueryKey(options)
    });
};

export const equipmentDisposeControllerRemoveByDecisionNumberMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerRemoveByDecisionNumberData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerRemoveByDecisionNumberResponse, AxiosError<EquipmentDisposeControllerRemoveByDecisionNumberError>, OptionsLegacyParser<EquipmentDisposeControllerRemoveByDecisionNumberData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerRemoveByDecisionNumber({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentDisposeControllerFindByDecisionNumberQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerFindByDecisionNumberData>) => [
    createQueryKey('equipmentDisposeControllerFindByDecisionNumber', options)
];

export const equipmentDisposeControllerFindByDecisionNumberOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerFindByDecisionNumberData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerFindByDecisionNumber({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerFindByDecisionNumberQueryKey(options)
    });
};

export const equipmentDisposeControllerGenerateLiquidationFormLayoutQueryKey = (options: OptionsLegacyParser<EquipmentDisposeControllerGenerateLiquidationFormLayoutData>) => [
    createQueryKey('equipmentDisposeControllerGenerateLiquidationFormLayout', options)
];

export const equipmentDisposeControllerGenerateLiquidationFormLayoutOptions = (options: OptionsLegacyParser<EquipmentDisposeControllerGenerateLiquidationFormLayoutData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerGenerateLiquidationFormLayout({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentDisposeControllerGenerateLiquidationFormLayoutQueryKey(options)
    });
};

export const equipmentDisposeControllerGenerateLiquidationFormLayoutMutation = (options?: Partial<OptionsLegacyParser<EquipmentDisposeControllerGenerateLiquidationFormLayoutData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentDisposeControllerGenerateLiquidationFormLayoutResponse, AxiosError<EquipmentDisposeControllerGenerateLiquidationFormLayoutError>, OptionsLegacyParser<EquipmentDisposeControllerGenerateLiquidationFormLayoutData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentDisposeService.equipmentDisposeControllerGenerateLiquidationFormLayout({
                ...options,
                ...localOptions,
...
export const equipmentRepairControllerRepairOptions = (options: OptionsLegacyParser<EquipmentRepairControllerRepairData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerRepair({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentRepairControllerRepairQueryKey(options)
    });
};

export const equipmentRepairControllerRepairMutation = (options?: Partial<OptionsLegacyParser<EquipmentRepairControllerRepairData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentRepairControllerRepairResponse, AxiosError<EquipmentRepairControllerRepairError>, OptionsLegacyParser<EquipmentRepairControllerRepairData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerRepair({
                ...options,
                ...localOptions,
...
export const equipmentRepairControllerSearchQueryKey = (options?: OptionsLegacyParser<EquipmentRepairControllerSearchData>) => [
    createQueryKey('equipmentRepairControllerSearch', options)
];

export const equipmentRepairControllerSearchOptions = (options?: OptionsLegacyParser<EquipmentRepairControllerSearchData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerSearch({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentRepairControllerSearchQueryKey(options)
    });
};

export const equipmentRepairControllerSearchInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentRepairControllerSearchData>): QueryKey<OptionsLegacyParser<EquipmentRepairControllerSearchData>> => [
    createQueryKey('equipmentRepairControllerSearch', options, true)
];

export const equipmentRepairControllerSearchInfiniteOptions = (options?: OptionsLegacyParser<EquipmentRepairControllerSearchData>) => {
    return infiniteQueryOptions<EquipmentRepairControllerSearchResponse, AxiosError<EquipmentRepairControllerSearchError>, InfiniteData<EquipmentRepairControllerSearchResponse>, QueryKey<OptionsLegacyParser<EquipmentRepairControllerSearchData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentRepairControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentRepairControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
...
export const equipmentRepairControllerUpdateMutation = (options?: Partial<OptionsLegacyParser<EquipmentRepairControllerUpdateData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentRepairControllerUpdateResponse, AxiosError<EquipmentRepairControllerUpdateError>, OptionsLegacyParser<EquipmentRepairControllerUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerUpdate({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentRepairControllerRemoveMutation = (options?: Partial<OptionsLegacyParser<EquipmentRepairControllerRemoveData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentRepairControllerRemoveResponse, AxiosError<EquipmentRepairControllerRemoveError>, OptionsLegacyParser<EquipmentRepairControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerRemove({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentRepairControllerCompleteQueryKey = (options: OptionsLegacyParser<EquipmentRepairControllerCompleteData>) => [
    createQueryKey('equipmentRepairControllerComplete', options)
];

export const equipmentRepairControllerCompleteOptions = (options: OptionsLegacyParser<EquipmentRepairControllerCompleteData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerComplete({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentRepairControllerCompleteQueryKey(options)
    });
};

export const equipmentRepairControllerCompleteMutation = (options?: Partial<OptionsLegacyParser<EquipmentRepairControllerCompleteData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentRepairControllerCompleteResponse, AxiosError<EquipmentRepairControllerCompleteError>, OptionsLegacyParser<EquipmentRepairControllerCompleteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await EquipmentRepairService.equipmentRepairControllerComplete({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerHandoverQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerHandoverData>) => [
    createQueryKey('equipmentHandoverControllerHandover', options)
];

export const equipmentHandoverControllerHandoverOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerHandoverData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerHandover({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerHandoverQueryKey(options)
    });
};

export const equipmentHandoverControllerHandoverMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerHandoverData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerHandoverResponse, AxiosError<EquipmentHandoverControllerHandoverError>, OptionsLegacyParser<EquipmentHandoverControllerHandoverData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerHandover({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerUpdateMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerUpdateData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerUpdateResponse, AxiosError<EquipmentHandoverControllerUpdateError>, OptionsLegacyParser<EquipmentHandoverControllerUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerUpdate({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentHandoverControllerDeleteMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerDeleteData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerDeleteResponse, AxiosError<EquipmentHandoverControllerDeleteError>, OptionsLegacyParser<EquipmentHandoverControllerDeleteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerDelete({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentHandoverControllerFindOneQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerFindOneData>) => [
    createQueryKey('equipmentHandoverControllerFindOne', options)
];

export const equipmentHandoverControllerFindOneOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerFindOneData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerFindOne({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerFindOneQueryKey(options)
    });
};

export const equipmentHandoverControllerValidateQuantitiesQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerValidateQuantitiesData>) => [
    createQueryKey('equipmentHandoverControllerValidateQuantities', options)
];

export const equipmentHandoverControllerValidateQuantitiesOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerValidateQuantitiesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerValidateQuantities({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerValidateQuantitiesQueryKey(options)
    });
};

export const equipmentHandoverControllerValidateQuantitiesMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerValidateQuantitiesData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerValidateQuantitiesResponse, AxiosError<EquipmentHandoverControllerValidateQuantitiesError>, OptionsLegacyParser<EquipmentHandoverControllerValidateQuantitiesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerValidateQuantities({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerSearchQueryKey = (options?: OptionsLegacyParser<EquipmentHandoverControllerSearchData>) => [
    createQueryKey('equipmentHandoverControllerSearch', options)
];

export const equipmentHandoverControllerSearchOptions = (options?: OptionsLegacyParser<EquipmentHandoverControllerSearchData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerSearch({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerSearchQueryKey(options)
    });
};

export const equipmentHandoverControllerSearchInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentHandoverControllerSearchData>): QueryKey<OptionsLegacyParser<EquipmentHandoverControllerSearchData>> => [
    createQueryKey('equipmentHandoverControllerSearch', options, true)
];

export const equipmentHandoverControllerSearchInfiniteOptions = (options?: OptionsLegacyParser<EquipmentHandoverControllerSearchData>) => {
    return infiniteQueryOptions<EquipmentHandoverControllerSearchResponse, AxiosError<EquipmentHandoverControllerSearchError>, InfiniteData<EquipmentHandoverControllerSearchResponse>, QueryKey<OptionsLegacyParser<EquipmentHandoverControllerSearchData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentHandoverControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentHandoverControllerSearchData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentHandoverControllerSearchInfiniteQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateHandoverReportFromLogQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverReportFromLogData>) => [
    createQueryKey('equipmentHandoverControllerGenerateHandoverReportFromLog', options)
];

export const equipmentHandoverControllerGenerateHandoverReportFromLogOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverReportFromLogData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateHandoverReportFromLog({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerGenerateHandoverReportFromLogQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateHandoverReportFromLogMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverReportFromLogData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerGenerateHandoverReportFromLogResponse, AxiosError<EquipmentHandoverControllerGenerateHandoverReportFromLogError>, OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverReportFromLogData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateHandoverReportFromLog({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerGenerateHandoverEvaluationReportByDateQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateData>) => [
    createQueryKey('equipmentHandoverControllerGenerateHandoverEvaluationReportByDate', options)
];

export const equipmentHandoverControllerGenerateHandoverEvaluationReportByDateOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateHandoverEvaluationReportByDate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerGenerateHandoverEvaluationReportByDateQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateHandoverEvaluationReportByDateMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateResponse, AxiosError<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateError>, OptionsLegacyParser<EquipmentHandoverControllerGenerateHandoverEvaluationReportByDateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateHandoverEvaluationReportByDate({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerGenerateAnnualReceptionReportQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualReceptionReportData>) => [
    createQueryKey('equipmentHandoverControllerGenerateAnnualReceptionReport', options)
];

export const equipmentHandoverControllerGenerateAnnualReceptionReportOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualReceptionReportData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualReceptionReport({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerGenerateAnnualReceptionReportQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateAnnualReceptionReportMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualReceptionReportData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerGenerateAnnualReceptionReportResponse, AxiosError<EquipmentHandoverControllerGenerateAnnualReceptionReportError>, OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualReceptionReportData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualReceptionReport({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerGenerateAnnualHandoverReportLayoutQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutData>) => [
    createQueryKey('equipmentHandoverControllerGenerateAnnualHandoverReportLayout', options)
];

export const equipmentHandoverControllerGenerateAnnualHandoverReportLayoutOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualHandoverReportLayout({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerGenerateAnnualHandoverReportLayoutQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateAnnualHandoverReportLayoutMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutResponse, AxiosError<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutError>, OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualHandoverReportLayoutData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualHandoverReportLayout({
                ...options,
                ...localOptions,
...
export const equipmentHandoverControllerGenerateAnnualRecallReportLayoutQueryKey = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutData>) => [
    createQueryKey('equipmentHandoverControllerGenerateAnnualRecallReportLayout', options)
];

export const equipmentHandoverControllerGenerateAnnualRecallReportLayoutOptions = (options: OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualRecallReportLayout({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentHandoverControllerGenerateAnnualRecallReportLayoutQueryKey(options)
    });
};

export const equipmentHandoverControllerGenerateAnnualRecallReportLayoutMutation = (options?: Partial<OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutResponse, AxiosError<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutError>, OptionsLegacyParser<EquipmentHandoverControllerGenerateAnnualRecallReportLayoutData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await HandoverEquipmentService.equipmentHandoverControllerGenerateAnnualRecallReportLayout({
                ...options,
                ...localOptions,
...
export const equipmentInstancesControllerGetInstancesWithGroupedDetailsQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>) => [
    createQueryKey('equipmentInstancesControllerGetInstancesWithGroupedDetails', options)
];

export const equipmentInstancesControllerGetInstancesWithGroupedDetailsOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerGetInstancesWithGroupedDetails({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentInstancesControllerGetInstancesWithGroupedDetailsQueryKey(options)
    });
};

export const equipmentInstancesControllerGetInstancesWithGroupedDetailsInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>): QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>> => [
    createQueryKey('equipmentInstancesControllerGetInstancesWithGroupedDetails', options, true)
];

export const equipmentInstancesControllerGetInstancesWithGroupedDetailsInfiniteOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>) => {
    return infiniteQueryOptions<EquipmentInstancesControllerGetInstancesWithGroupedDetailsResponse, AxiosError<EquipmentInstancesControllerGetInstancesWithGroupedDetailsError>, InfiniteData<EquipmentInstancesControllerGetInstancesWithGroupedDetailsResponse>, QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInstancesWithGroupedDetailsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentInstancesControllerGetInstancesWithGroupedDetailsInfiniteQueryKey(options)
    });
};

export const equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>) => [
    createQueryKey('equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnit', options)
];

export const equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnit({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitQueryKey(options)
    });
};

export const equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>): QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>> => [
    createQueryKey('equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnit', options, true)
];

export const equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitInfiniteOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>) => {
    return infiniteQueryOptions<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitResponse, AxiosError<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitError>, InfiniteData<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitResponse>, QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentInstancesControllerGetDetailsGroupedByInstanceAndUnitInfiniteQueryKey(options)
    });
};

export const equipmentInstancesControllerUpdateInventoryMutation = (options?: Partial<OptionsLegacyParser<EquipmentInstancesControllerUpdateInventoryData>>) => {
    const mutationOptions: UseMutationOptions<EquipmentInstancesControllerUpdateInventoryResponse, AxiosError<EquipmentInstancesControllerUpdateInventoryError>, OptionsLegacyParser<EquipmentInstancesControllerUpdateInventoryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerUpdateInventory({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const equipmentInstancesControllerGetInventoryDataQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>) => [
    createQueryKey('equipmentInstancesControllerGetInventoryData', options)
];

export const equipmentInstancesControllerGetInventoryDataOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerGetInventoryData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentInstancesControllerGetInventoryDataQueryKey(options)
    });
};

export const equipmentInstancesControllerGetInventoryDataInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>): QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>> => [
    createQueryKey('equipmentInstancesControllerGetInventoryData', options, true)
];

export const equipmentInstancesControllerGetInventoryDataInfiniteOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>) => {
    return infiniteQueryOptions<EquipmentInstancesControllerGetInventoryDataResponse, AxiosError<EquipmentInstancesControllerGetInventoryDataError>, InfiniteData<EquipmentInstancesControllerGetInventoryDataResponse>, QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetInventoryDataData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentInstancesControllerGetInventoryDataInfiniteQueryKey(options)
    });
};

export const equipmentInstancesControllerGenerateInventoryReportQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>) => [
    createQueryKey('equipmentInstancesControllerGenerateInventoryReport', options)
];

export const equipmentInstancesControllerGenerateInventoryReportOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerGenerateInventoryReport({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentInstancesControllerGenerateInventoryReportQueryKey(options)
    });
};

export const equipmentInstancesControllerGenerateInventoryReportInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>): QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>> => [
    createQueryKey('equipmentInstancesControllerGenerateInventoryReport', options, true)
];

export const equipmentInstancesControllerGenerateInventoryReportInfiniteOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>) => {
    return infiniteQueryOptions<EquipmentInstancesControllerGenerateInventoryReportResponse, AxiosError<EquipmentInstancesControllerGenerateInventoryReportError>, InfiniteData<EquipmentInstancesControllerGenerateInventoryReportResponse>, QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGenerateInventoryReportData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentInstancesControllerGenerateInventoryReportInfiniteQueryKey(options)
    });
};

export const equipmentInstancesControllerGetGeneralInventoryReportQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>) => [
    createQueryKey('equipmentInstancesControllerGetGeneralInventoryReport', options)
];

export const equipmentInstancesControllerGetGeneralInventoryReportOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await SyncEquipmentsInstancesService.equipmentInstancesControllerGetGeneralInventoryReport({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: equipmentInstancesControllerGetGeneralInventoryReportQueryKey(options)
    });
};

export const equipmentInstancesControllerGetGeneralInventoryReportInfiniteQueryKey = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>): QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>> => [
    createQueryKey('equipmentInstancesControllerGetGeneralInventoryReport', options, true)
];

export const equipmentInstancesControllerGetGeneralInventoryReportInfiniteOptions = (options?: OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>) => {
    return infiniteQueryOptions<EquipmentInstancesControllerGetGeneralInventoryReportResponse, AxiosError<EquipmentInstancesControllerGetGeneralInventoryReportError>, InfiniteData<EquipmentInstancesControllerGetGeneralInventoryReportResponse>, QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>>, number | Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<OptionsLegacyParser<EquipmentInstancesControllerGetGeneralInventoryReportData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: equipmentInstancesControllerGetGeneralInventoryReportInfiniteQueryKey(options)
    });
};