...
export const equipmentInstancesControllerGetInstancesWithGroupedDetailsQueryKey = (options?: OptionsLegacyParser) => [
    createQueryKey('equipmentInstancesControllerGetInstancesWithGroupedDetails', options)
];

export const equipmentInstancesControllerGetInstancesWithGroupedDetailsOptions = (options?: OptionsLegacyParser) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
